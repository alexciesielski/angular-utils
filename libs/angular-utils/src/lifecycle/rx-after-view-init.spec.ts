...
import { AfterViewInit, Component, DestroyRef, EventEmitter, OnDestroy, Output, inject } from '@angular/core';
...
class DecoratedComponent implements AfterViewInit, RxAfterViewInit, OnDestroy {
  constructor() {
    this.emitter$$
      .pipe(
        take(3),
        ...
        tap((emitted) => {
          const compareTo = ['constructor', 'ngAfterViewInit', 'rxAfterViewInit'];
    ...
    this.ngAfterViewInit$.subscribe(() => {
      this.emitter$$.next('rxAfterViewInit');
  ...
  ngAfterViewInit() {
    this.emitter$$.next('ngAfterViewInit');
...
describe('RxAfterViewInit', () => {
  ...
  it('should emit after ngAfterViewInit', fakeAsync(() => {
